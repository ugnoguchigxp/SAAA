...
export const QUALITY_SCENARIOS: QualityScenario[] = [
  ...cases("ja", "ja", [
    ...
    [
      "次の文の要点を一文にしてください。品質を上げるには、失敗を隠さず計測し、原因ごとに直す必要があります。",
      "計測と原因別改善を一文で要約する",
    ],
  ...
  ...cases("en", "en", [
    ...
    [
      "Summarize in one sentence: Good systems expose failures and make recovery explicit.",
      "Preserve the main point in one sentence",
    ],
  ...
  ...cases("long", "ja", [
    [
      "在宅勤務の利点と注意点を、結論を先にして4項目以内で説明してください。",
      "結論先行で4項目以内、反復しない",
    ],
    [
      "バックアップ運用を初めて担当する人向けに、毎週の確認手順を説明してください。",
      "順序が明確で実行可能、過剰な前置きなし",
    ],
    [
      "小規模チームが障害対応を改善する方法を300字以内で教えて。",
      "300字以内で具体的な改善策を示す",
    ],
    [
      "パスワード管理ツールを導入する際の判断基準を説明して。",
      "安全性と運用性を偏りなく簡潔に示す",
    ],
    [
      "新機能の段階リリースが必要な理由を、非エンジニアにも分かるように説明して。",
      "専門用語を抑え段階リリースの価値を説明する",
    ],
    [
      "音声アプリで遅延と精度のどちらを優先すべきか、判断軸を示して。",
      "一律に断定せず用途別の判断軸を示す",
    ],
    ["失敗した処理の再試行設計で注意することを説明して。", "重複防止、範囲、状態を含める"],
    [
      "ユーザー設定画面を分かりやすくする原則を、例を交えて説明して。",
      "実際に変更可能な値と状態表示を区別する",
    ],
  ]),
  ...cases(
    ...
    "success",
    "Deterministic test search result: requested item is Sample A, updated 2026-08-30 09:00 JST.",
  ),
  ...cases(
    "tool-failure",
    "ja",
    ...
    "failure",
    "Tool error: deterministic network failure.",
  ),
  ...cases("continuation", "ja", [
    [
      "回答が途中で切れました。重複せず、バックアップ確認の2番目の手順から続けて。",
      "冒頭を繰り返さず指定位置から続ける",
    ],
