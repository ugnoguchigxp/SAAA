...
function snapshot(): AppSnapshot {
  return {
    ...
    voiceProfile: { status: "empty", filterEnabled: false, runtimeAvailable: false, runtimeMessage: "", sampleCount: 0, targetSampleCount: 5, totalDurationMs: 0, minimumDurationMs: 20_000, threshold: 0.55, samples: [] },
  };
}
...
describe("effective provider route", () => {
  test("readiness comes from the runtime snapshot, not configured endpoint strings", () => {
    ...
    current.effectiveRoute = { providerId: "local", label: "Local", location: "local", state: "unchecked", fallbackUsed: false, reasonCode: "not-probed", updatedAt: null };
