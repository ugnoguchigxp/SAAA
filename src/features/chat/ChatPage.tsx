...
import { CompletedMessage, StreamingPlainText } from "./ChatMessages";
...
export function ChatPage({
  ...
  useEffect(() => {
    ...
    if (!messageArea || !followLatestRef.current) return;
