export const ja = {
  ...
  voice: {
    ...
    profile: {
      ...
      storage: "音声ファイルと話者埋め込みは暗号化して端末内へ保存します。鍵はmacOS Keychainに保存し、クラウドへ送信しません。",
      limitation: "これは文字起こし対象を絞る機能で、本人認証や録音・合成音声の検出には使用できません。",
      deleteProfile: "声プロファイル全体を削除",
      noAudio: "音声が記録されませんでした。",
      sampleSaved: "サンプル {{current}}/{{target}} を暗号化して保存しました。",
      confirmDeleteSample: "この音声サンプルを削除しますか？",
      sampleDeleted: "音声サンプルを削除しました。",
      confirmDeleteProfile: "声プロファイル、暗号化音声、Keychainの鍵をすべて削除しますか？",
