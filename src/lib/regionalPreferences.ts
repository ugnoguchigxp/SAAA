...
export const DISPLAY_LANGUAGE_PREFERENCES = [
  "system",
  "en",
  "ja",
] as const satisfies readonly DisplayLanguagePreference[];
export const LENGTH_UNIT_SYSTEMS = [
  "metric",
  "imperial",
] as const satisfies readonly LengthUnitSystem[];
