...
export type RuntimeEvent = { "type": "started", runId: string, route: string, providerId: string, } | { "type": "providerSelected", runId: string, providerId: string, providerKind: "larm", routeId: "llm-default", runtimeId: string, fallbackUsed: boolean, selectionReasonCode: "primary" | "other", } | { "type": "delta", runId: string, text: string, } | { "type": "activity", runId: string, kind: string, summary: string, } | { "type": "providerFailed", runId: string, providerId: string, reason: string, } | { "type": "messageCompleted", runId: string, message: ConversationMessage, } | { "type": "cancelled", runId: string, } | { "type": "failed", runId: string, code: RuntimeFailureCode, message: string, recovery: string, };
