...
export const voiceAsrFailureCodes = ["asr-session-exists", "asr-session-not-found", "asr-packet-format", "asr-packet-sequence", "asr-backpressure", "asr-provider-unavailable", "asr-stream-protocol", "asr-stream-timeout", "asr-final-timeout", "asr-target-speaker-unavailable", "asr-language-not-allowed", "asr-no-speech", "asr-cancelled"] as const;
