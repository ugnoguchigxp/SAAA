...
export type ScheduleStatus = { enabled: boolean, calendarEnabled: boolean, calendarId: string | null, calendarConnected: boolean, lastError: string | null, platformSupported: boolean, oauthClientId: string | null, };
