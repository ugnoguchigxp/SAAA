...
pub(crate) const MAX_NEIGHBOR_TURNS: i64 = 2;
pub(super) const MAX_EVENTS_PER_WINDOW: usize = 32;
pub(crate) const MAX_MERGED_EVENTS_PER_WINDOW: usize = 64;
// UTF-8 bytes are a provider-independent upper bound on subword-token count.
pub(super) const MAX_OUTPUT_TOKEN_BUDGET: usize = 3_000;
const CANDIDATE_BATCH_SIZE: usize = 5;
const MAX_CANDIDATE_SCAN: usize = CANDIDATE_BATCH_SIZE;
pub(super) const CURSOR_TTL_MS: i64 = 24 * 60 * 60 * 1_000;
...
pub(super) struct CursorState {
    ...
    pub(super) range: Option<ResolvedRange>,
    pub(super) snapshot_max_rowid: i64,
}
#[derive(Debug, Clone)]
...
pub(super) struct InternalEvent {
    ...
    pub(super) rowid: i64,
    pub(super) turn_sequence: i64,
}
#[derive(Debug, Clone)]
pub(super) struct InternalWindow {
    pub(super) conversation_id: String,
    pub(super) first_turn: i64,
    pub(super) last_turn: i64,
    pub(super) score: f64,
    pub(super) matched_event_refs: Vec<String>,
    pub(super) events: Vec<InternalEvent>,
}
