...
#[test]
fn world_projection_does_not_resurrect_a_deleted_source_on_restore() {
...
#[test]
fn world_assertions_stay_out_of_the_public_snapshot() {
    use crate::memory::personal_state::world::test_support::{
        entity_assertion, insert_source, Committer, PROJECT,
    };
    use saaa_personal_state_core::world::EntityKind;
    ...
    writer
        .read_serialized(|c| {
            let snapshot = super::commands::snapshot(c)?;
