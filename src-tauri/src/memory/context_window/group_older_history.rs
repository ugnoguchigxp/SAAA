use super::*;
pub(super) fn group_older_history(source: &[SourceMessage]) -> Vec<ContinuityGroup> {
...
pub(super) fn project_group(messages: &[&SourceMessage]) -> ContinuityGroup {
...
pub(super) fn select_continuity_groups(
...
pub(super) fn render_group(group: &ContinuityGroup) -> String {
...
pub(super) fn event_ref(message_id: &str) -> String {
