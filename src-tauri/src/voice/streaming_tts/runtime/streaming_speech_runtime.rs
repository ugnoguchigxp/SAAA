use super::*;
pub(crate) const MAX_QUEUED_CHUNKS: usize = 32;
pub(crate) const MAX_RENDER_CONCURRENCY: usize = 3;
pub(crate) const MAX_READY_CHUNKS: usize = 3;
pub(crate) const MAX_READY_AUDIO_BYTES: u64 = 16 * 1_024 * 1_024;
pub(crate) const MAX_READY_AUDIO_MS: u64 = 30_000;
...
pub(crate) struct SpeechSession {
    ...
    pub(crate) work: mpsc::Sender<SpeechWork>,
    pub(crate) cancellation: Arc<RunCancellation>,
    pub(crate) child: Arc<Mutex<Option<Child>>>,
    pub(crate) closed: bool,
    pub(crate) enabled: bool,
    pub(crate) idle_timer: Option<tauri::async_runtime::JoinHandle<()>>,
    pub(crate) idle_reset: watch::Sender<Option<u64>>,
    pub(crate) writer: Option<Arc<crate::persistence::SqliteWriter>>,
    pub(crate) expression: crate::voice::cloud_tts::speech_directive::SpeechExpression,
    pub(crate) expression_locked: bool,
}
pub(crate) enum SpeechWork {
    Chunk {
        text: String,
...
pub(crate) fn queue_chunk(session: &mut SpeechSession, text: String) -> Result<(), String> {
...
pub(crate) struct RenderSessionContext {
    pub(crate) route: TtsRoute,
    pub(crate) timeout_ms: u64,
    pub(crate) cancellation: Arc<RunCancellation>,
    pub(crate) child: Arc<Mutex<Option<Child>>>,
    pub(crate) cache_directory: PathBuf,
    pub(crate) situation: Arc<crate::situation::SituationRuntime>,
    pub(crate) on_event: tauri::ipc::Channel<RuntimeEvent>,
...
pub(crate) struct RenderedChunk {
    ...
    pub(crate) boundary_at: Instant,
    pub(crate) path: PathBuf,
    pub(crate) bytes: u64,
    pub(crate) audio_ms: u64,
    pub(crate) synthesis_ms: u64,
}
...
pub(crate) type RenderFuture = Pin<Box<dyn Future<Output = Result<RenderedChunk, String>> + Send>>;
pub(crate) type PlaybackTask =
