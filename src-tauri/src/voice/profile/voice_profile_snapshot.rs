...
pub(super) const MAX_SAMPLE_SECONDS: f32 = 12.0;
pub(super) const TARGET_SAMPLE_COUNT: usize = 5;
pub(super) const MIN_READY_SAMPLES: usize = TARGET_SAMPLE_COUNT;
pub(super) const MIN_READY_DURATION_MS: u64 = 50_000;
...
pub struct VoiceProfileRuntime {
    ...
    pub(super) extractor: Option<SpeakerExtractor>,
...
impl VoiceProfileRuntime {
    ...
    pub(super) fn snapshot(&self, connection: &Connection) -> Result<VoiceProfileSnapshot, String> {
    ...
    pub(super) fn delete_sample_from_connection(
        &self,
        connection: &Connection,
        sample_id: &str,
    ) -> Result<VoiceProfileSnapshot, String> {
    ...
    pub(crate) fn delete_profile_from_connection(
        &self,
        connection: &Connection,
    ) -> Result<VoiceProfileSnapshot, String> {
        let paths = connection
...
pub(super) fn enrollment_uses_input_device(
    connection: &Connection,
    input_device_id: &str,
) -> Result<bool, String> {
