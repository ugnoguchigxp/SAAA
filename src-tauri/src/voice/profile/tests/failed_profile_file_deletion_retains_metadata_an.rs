...
use super::*;
#[test]
    pub(super) fn failed_profile_file_deletion_retains_metadata_and_retry_converges() {
...
#[cfg(unix)]
    #[test]
    pub(super) fn plaintext_voice_samples_keep_private_filesystem_permissions() {
